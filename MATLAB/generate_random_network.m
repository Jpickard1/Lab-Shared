...
switch type
    case 'ER'
        network = randomNetworks.erdos_renyi_network(V, E);
    case 'ERG'
        network = randomNetworks.erdos_renyi_gilbert_network(V, 0.2);
    case 'QR'
        network = randomNetworks.quasi_ramanujan_network(V, k, params('Beta'));
    case 'SF'
        network = randomNetworks.scale_free_network(V, 5);
    case 'SW'
        network = randomNetworks.small_world_network(V, k, params('Beta'));
end
